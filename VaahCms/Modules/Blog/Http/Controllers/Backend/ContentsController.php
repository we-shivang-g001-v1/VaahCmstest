...
use VaahCms\Modules\Blog\Models\Content;
...
class ContentsController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['fillable']['columns'] = Content::getFillableColumns();
            $data['fillable']['except'] = Content::getUnFillableColumns();
            $data['empty_item'] = Content::getEmptyItem();
    ...
    {
        try{
            return Content::fillItem($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
