        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="contents-actions-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <Button
                                ...
                                data-testid="contents-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="contents-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
                                ...
                                <Button
                                    ...
                                    data-testid="contents-actions-bulk-menu"
                                    aria-haspopup="true"
